...
public class OriginalLinearProcessing {
    ...
    static long _WS = 160000;
    static long _WA = 160000;
    static boolean metrics = false;
    static int _Injection_Rate = 28000;
    ...
    private static Options buildOptions() {
        ...
        options.addOption("rate", "rate", true, "Injection rate in terms of number of tuples per millisec");
        ...
        for (Iterator<Option> itr = cl.iterator(); itr.hasNext(); ) {
            ...
            switch (opt.getOpt()) {
                ...
                case "rate":
                    ...
                    break;
                case "r":
                    _WA = Long.parseLong(opt.getValue());
                    break;
                case "f":
                    _Flow_Control = true;
                    break;
    ...
    public static void main(String[] args) throws Exception {
        ...
        OriginalGraph graph = new OriginalGraph(config, _NUM_Scouts);
        ...
        List<Operator<LidarPoint, Clusters>> scouts = q.addTimeAggregateOperator("scout", _NUM_Scouts, _WS,
                _WA, new OriginalLisco(config, graph));
